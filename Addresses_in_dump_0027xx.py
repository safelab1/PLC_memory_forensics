...
print " DUMP is taken from 0x5000 0000 , while addresses start at 0x0000 0000"
print " ---------------------------------------------------------------------------------------------------------------------------------"
time.sleep(0.2)
...
for entry1 in entries:
    ...
    starting_addr = int(entry1.split("_")[-3],16)-0x50000000 #using this line for data extracted after 5000 0000; though it is same as 0x0000 00000
