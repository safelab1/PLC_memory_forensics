...
print(time.strftime("%Y%m%d-%H%M%S"))
outfile = open(dest_folder+"code_mem"+ " _time_"+str(timestr) + "_mem_from_"+hex(p1_start_addr)+"_to_"+hex(p1_end_addr)+ "_AND_from_" +hex(p2_start_addr)+"_to_"+hex(p2_end_addr)+".bin","ab")
